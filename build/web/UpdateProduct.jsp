            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-family: 'Open Sans Condensed', sans-serif; font-size: 28px;"> 
                        <b>
                            <input type="text" placeholder="Category Name" class="form-control" value="${product.getCategoryname()}" name="categoryname"/> 
                        </b>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="font-family: 'Open Sans Condensed', sans-serif; font-size: 28px;"> 
                        <b>
                            <input type="text" placeholder="Category Name" class="form-control" value="${product.getProductname()}" name="productname"/> 
                        </b>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="font-family: 'Open Sans Condensed', sans-serif; font-size: 28px;">
                        <b>
                            <input type="text" placeholder="Category Description" class="form-control" value="${product.getPrice()}" name="price"/> 
                        </b>
                    </td>
                </tr>
